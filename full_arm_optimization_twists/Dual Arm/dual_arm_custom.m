...
T_R(1:3,1:3) = roty(-pi/2)*rotx(-0*pi/4);
T_R(1:3,end) = [-3;-6.0107;4.9967];
T_L(1:3,1:3) = roty(pi/2)*rotx(-0*pi/4);
T_L(1:3,end) = [3;-6.0107;4.9967];

T_B = {T_L, T_R};

% init_a = [0.9998   -0.9834    0.3016   -0.5236   -0.8948   -0.8543    0.9248   -0.4488    0.9948    1.9994    1.9895...
%    -1.9846   -1.4524   -1.9511    1.6301    1.8253    0.2947    0.3526    3.0000   -6.0107    4.9967];
% temp = [4.7491 3.9444 -4.7350];
